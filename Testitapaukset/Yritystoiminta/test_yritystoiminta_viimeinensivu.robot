...
${PAGE2}			Suunnittele jo liikeideaa miettiessäsi, mitä tavaroita tai palveluja yrityksesi myy ja markkinoi
...
*** Test Cases ***
Test last page functionality
	[Documentation]			Testaa viimeisen sivun toimintaa
	Business Idea			true
...
Last Page True
	...
	Focus And Click On Radio Button		corporateFormInitialInvestmentOver2500eur  	true
	Focus And Click On Radio Button		corporateFormStartWithPartner  				true
	Focus And Click On Radio Button		corporateFormEqualWithPartner  				true
	Focus And Click On Radio Button		corporateFormSilentPartners					true
	
Last Page Test
	[Documentation]		Testaa, ettei elementit ole näkyvissä ennen elementtien painamista
	Verify Page		${LASTPAGE}
	Element Should Not Be Visible		xpath=//input[@name='corporateFormEqualWithPartner']
	Element Should Not Be Visible		xpath=//input[@name='corporateFormSilentPartners']
	Last Page True
	Move To Next Page