...
Go forward and then back
	[Documentation]			Testi menee ensin neljä sivua eteenpäin, ja palaa sen jälkeen painamalla "Edellinen"-nappia
	Business Idea			true
...
Business Idea
	...
	[Arguments]		${value}
	Verify Page		Yritysidea kertoo, miksi yrityksesi on olemassa
...
Go Back To Start
	[Documentation] 	Painelee "Edellinen"-nappia muutaman kerran
	Click Button	xpath=//button[@label='Edellinen']
	Click Button	xpath=//button[@label='Edellinen']
	Click Button	xpath=//button[@label='Edellinen']
	Click Button	xpath=//button[@label='Edellinen']
	Click Button	xpath=//button[@label='Edellinen']