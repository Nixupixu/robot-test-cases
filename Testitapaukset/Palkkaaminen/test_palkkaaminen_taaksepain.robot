...
*** Test Cases ***
Go through wizard
	[Documentation]		Käy wizardia läpi muutaman sivun, sen jälkeen palaa alkuun valitsemalla listasta "Aloitus"
	Labour Method
	Employment
	Recruiting
	Go Back To Start
...
Go Back To Start
	[Documentation]		Palaa alkuun valitsemalla listasta "Aloitus"
