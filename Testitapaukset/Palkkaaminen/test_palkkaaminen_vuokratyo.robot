...
*** Test Cases ***
Go through wizard
	[Documentation]		Tarkistaa, meneekö vuokratyövoiman valinnalla suoraan muistioon
	Leased Personnel
	Verify Page		${SUMMARY}
...
Leased Personnel
	...
	Wait Until Page Contains 		Käytän henkilöstöyrityksen vuokratyövoimaa.
	Click Element At Coordinates	xpath=//*[@name = 'labourMethodLeasedPersonnel']	0	0
	Click Button					xpath=//button[@label = 'Seuraava']