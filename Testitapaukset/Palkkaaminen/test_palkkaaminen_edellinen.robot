...
*** Test Cases ***
Go through wizard
	[Documentation]		Käy wizardia läpi muutaman sivun, jonka jälkeen palaa alkuun painamalla "Edellinen" -nappia
	Labour Method
	Employment
	Recruiting
	Go Back To Start
...
Go Back To Start
	[Documentation]		Menee alkuun tarkistaen, että ollaan oikealla sivulla, jonka jälkeen painaa "Edellinen"-nappia
