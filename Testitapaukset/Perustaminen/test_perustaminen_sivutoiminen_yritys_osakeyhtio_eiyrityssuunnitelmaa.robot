...
Go through wizard
	...
	Insurances
	Taxes
	Verify Page			Muistilista on suositus yrityksesi perustamistoimista
...
Social Security
	[Documentation]		Tarkistaa, että ollaan oikealla sivulla, jonka jälkeen kutsuu nimettyjen elementtien painamista. Sen jälkeen siirtyy seuraavalle sivulle
	[Arguments] 	${value}
	Verify Page		Pohjoismaita ovat Ruotsi, Tanska, Norja ja Islanti.
	Focus And Click On Button		hasPersonalIdentificationNumber		${value}
	Move To Next Page
...
Corporate Form
	...
	Wait Until Page Contains Element	xpath=//div[@class='Select-input']//input[@value='']
