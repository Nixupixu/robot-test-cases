...
*** Test Cases ***
Go through wizard
	Nationality			EU_OR_ETA
	Length Of Stay		OVER_1_YEAR
	...
	Verify Page			Rekisteröi oleskeluoikeus
	Verify Page			Hae henkilötunnusta
...
Length Of Stay
	[Documentation]		Tarkistaa, että ollaan oikealla sivulla, jonka jälkeen kutsuu nimettyjen elementtien painamista. Sen jälkeen siirtyy seuraavalle sivulle
	[Arguments]		${value}
	Verify Page		Euroopan unionin (EU) maiden kansalaiset voivat vapaasti muuttaa EU:n alueella maasta toiseen
	Focus And Click On Button		euLengthOfStay		${value}
	Move To Next Page
